		...
		<div class="row clearfix">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							...
							<div class="body">
								<form class="form-horizontal myForm " action="{{route('products.store')}}" method="post"  enctype="multipart/form-data">
									{{csrf_field()}}
									...
									<div class="row clearfix">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
											<div class="form-group">
												<div class="form-line">
													<input id="email_address_2" class="form-control" name="name" placeholder="Enter Product Name" type="text">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row clearfix">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
											<div class="form-group">
												<div class="form-line">
													<input id="email_address_2" class="form-control" name="price" placeholder="Enter Product Price" type="text">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row clearfix">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
											<div class="form-group">
												<div class="form-line">
													<textarea rows="3" class="form-control no-resize" name="description" placeholder="Please describe the product..."></textarea>
												</div>
											</div>
										</div>
									</div>
